...
When designing your UI, you can reference data from your Views too. So, if you have a table with your sales people, and their total sales, you can create a View, and create a new calculation which gives you the total sales of all sales people. You can then reference this View in the design section of Budibase, and display the calculation.
